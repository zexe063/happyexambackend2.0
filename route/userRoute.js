...
const { getUser, verifyUser, createUser, ProgressEvent, revenueCatPayment, userProfile, userPassword, progressEvent, deleteUser} = require('../controller/userController');
const userRouter = express.Router();
 ...
 userRouter.post("/revenuecat-webhook", revenueCatPayment)
